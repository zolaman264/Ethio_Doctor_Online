            ...
            <div style="width: 100%;">
                ...
                <div id="right_content" style="display: flex;width: 700px;">
                    ...
                    <div class="facts" style="width: 100%;">
                       <span style="color: white; font-weight: lighter;font-style: italic;"> <u>Unchecked Questions:</u></span>
                        <?php foreach($allQuestion as $row){ ?>
                            ...
                            <ul class="tab-left" style="border-bottom: 1px solid white; padding-bottom: 5px;">
                                ...
                                <div style="width: 65%;">
                                    ...
                                    <div class="tab-text">
                                        <?php
                                        if(strlen($row->uqcontent) > 65 )
                                            echo "<p><a href='#' style='color:white;'>".substr($row->uqcontent,0,65)."</a></p>";
                                        else if(strlen($row->uqcontent) > 0 )
                                            echo "<p><a href='#' style='color:white;'>".$row->uqcontent."</a></p>";
                                        else
                                            echo $row->uqcontent;?>

                                        <div class="post-meta">
                                            <img src="<?php echo base_url("images/date.png"); ?>" alt=""><a href="#" class="date"><?php echo substr($row->uqtime,0,10);?></a>
                                        </div>
                                        <div style="display: none;">
                                            <input type="text" name="uq_id" value="<?php echo $row->uq_id;?>"/>
                                            <input type="text" name="uqcatagory" value="<?php echo $row->uqcatagory;?>"/>
                                            <input type="text" name="uqtitle" value="<?php echo $row->uqtitle;?>"/>
                                            <input type="text" name="uqcontent" value="<?php echo $row->uqcontent;?>"/>
                                            <input type="text" name="username" value="<?php echo $row->username;?>"/>
                                            <input type="text" name="uqtime" value="<?php echo $row->uqtime;?>"/>
                                            <input type="text" name="item" value="questions"/>
                                        </div>

                                    </div>

                                </div>
                                <div class="post-meta" style="float: right;width: 33%;">
