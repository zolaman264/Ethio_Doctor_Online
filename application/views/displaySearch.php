                                            ...
                                            <div>
                                                ...
                                                <table style="width:70%;padding:0px 20px;margin-left: 100px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <span><label style="color: #ffffff;"><?php echo $val->user_id;?></label>
                                                            <input style="visibility: hidden;" name="usrId" value="<?php echo $val->user_id;?>"/>
                                                            </span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <span><label style="color: #ffffff;"><?php echo $val->uname;?></label></span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2"><span><input type="submit" value="Confirm" style="margin: 20px 80px 0px 0px;"></span>
