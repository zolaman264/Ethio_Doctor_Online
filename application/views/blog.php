...
<div class="slider_bg">
    <div class="wrap">
        <div class="slider">
            <h2>Blog</h2>
            <h3>What We Think, Share Ideas...</h3>
        </div>
    </div>
</div>
<!-- start main -->
...
<div class="blog_left">
    ...
    <?php foreach($questions as $vals){ ?>
        <div class="blog_main" style="margin: 0px 0px 10px 0px; background: #eeeeee;">
            ...
            <div class="b_right">
                <h4><?php echo $vals->btitle;?></h4>
                <div class="blog_list">
                    <ul>
                        <li><a href="#"> <i class="date"> </i><span><?php echo substr($vals->btime,0,10);?></span></a></li>
                        <li><a href="#" onclick="drop_down_cmt(<?php echo $vals->b_id;?>,<?php echo 0;?>)"> <i class="comment"> </i> <span>Comments</span></a></li>
                ...
                <div class="blog_art">
                    <ul>
                        <li><a href="#"> <i> </i><span><?php echo $vals->blike;?></span></a></li>
                    </ul>
                    <div class="clear"></div>
                </div>
            </div>
            <div class="clear"></div>
            <p style="margin-bottom: 10px;"><?php echo substr($vals->bcontent,0,450)."...";?></p>
            <a class="btn" href="details.html">read more</a>
            <div style="min-height: 130px;width: 100%;">
            <div id="<?php echo $vals->b_id."0";?>" class="droplists" style="display: block;">
                <div class="contact_right" style="padding: 5px 5px 5px 5px;width: 100%;">
                    <?php echo form_open('Welcome/takeCommentIn'); ?>
                        <div class="contact-form" >
                            <input name="owner" value="<?php echo 'b'.$vals->b_id;?>" style="visibility: hidden;"/>
                ...
                foreach($comments as $vals3){
                    if('b'.$vals->b_id == $vals3->com_owner){
        ...
        <div class="contact" style="margin: 10px;">
            <div class="contact_right" style="width: 95%;margin: 0% 2%;">
                <div class="contact-form">
                    ...
                    <?php echo form_open('Welcome/doBlog'); ?>
                    <div>
                        <span><label>Title</label></span>
                        <span><input name="title" type="text" class="textbox" required="required" placeholder="Title of an Issue..."></span>
                    </div>
                    <div class="clear"></div>
                    <div style="width: 100%; padding: 1%;">
                        <div style="width: 49%;">
                            ...
                            <select name="catagory" style="width: 80%;" required="required">
                                ...
                                <option value="Sexual">Other</option>
                            </select>
                        </div>
                    </div>
                    <div>
