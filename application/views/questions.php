...
<head>
    ...
    <script>
        function styler($item){
            $item.style.display = "none";
        }
        function drop_down_ans($item_id,$item_id2){
            var temp = 0;
            var var1 = $item_id.toString();
            var var2 = $item_id2.toString();
            var var3 = temp.toString();
            var div_id = var1+var2;
            var div_id2 = var1+var3;
            document.getElementById(div_id).style.display = "block";
            document.getElementById(div_id2).style.display = "none";
        }
        function drop_down_cmt($item_id,$item_id2){
            var temp = 1;
            var var1 = $item_id.toString();
            var var2 = $item_id2.toString();
            var var3 = temp.toString();
        ...
        <div class="header" style="padding-top: 0;">
            ...
            <div class="h_right" style="margin-top: 5px;">
                <ul class="menu">
                    ...
                    <li class="active"><a href="<?php echo base_url("welcome/questions"); ?>">Question</a></li>
...
<div class="slider_bg">
    <div class="wrap">
        <div class="slider">
            <h2>Blog</h2>
            <h3>What We Think, Find You an Answer...</h3>
        </div>
    </div>
</div>
<!-- start main -->
...
<div>
    <div style="min-height: 650px;">
        <?php foreach($questions as $vals){ ?>
            <div class="blog_main" style="margin: 0px 0px 10px 0px; background: #eeeeee;">
                <div class="b_left">
                    <h4 class="bg"><img src="<?php echo base_url("images/note.jpg"); ?>" alt=""/></h4>
                </div>
                <div class="b_right">
                    <h4><?php echo $vals->qtitle;?></h4>
                    <div class="blog_list">
                        <ul>
                            <li><a href="#"> <i class="date"> </i><span><?php echo substr($vals->qtime,0,10);?></span></a></li>
                            <li><a href="#" onclick="drop_down_cmt(<?php echo $vals->q_id;?>,<?php echo 0;?>)"> <i class="comment"> </i> <span>Comments</span></a></li>
                            <li><a href="#" onclick="drop_down_ans(<?php echo $vals->q_id;?>,<?php echo 1;?>)"> <i class="news"> </i><span>Answers</span></a></li>
                    ...
                    <div class="blog_art">
                        <ul>
                            <li><a href="#"> <i> </i><span><?php echo $vals->qlikes;?></span></a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </div>
                <div class="clear"></div>
                <p style="margin-bottom: 10px;"><?php echo substr($vals->qcontent,0,450)."...";?></p>
                <a class="btn" href="details.html">read more</a>
                <div style="min-height: 130px;width: 100%;">
                    <div id="<?php echo $vals->q_id."1";?>" class="droplists" style="display: block;">
                        <?php if($this->session->userdata('user_type') == 'pro'){?>
                            <div class="contact_right" style="padding: 5px 5px 5px 5px;width: 100%;">
                                <?php echo form_open('Welcome/takeCommentIn'); ?>
                                <div class="contact-form" >
                                    <input name="owner" value="<?php echo $vals->q_id;?>" style="visibility: hidden;"/>
                                    <input name="blog" value="blog" style="visibility: hidden;"/>
                                    <input name="table" value="answer" style="visibility: hidden;"/>
                                    <input type="text" placeholder="leave your Answer  here..." name="QuestionComment" class="textbox" style="margin-left:20px;width: 73%;float:left;"/>
                        ...
                        <?php
                        $com_counter = 0;
                        foreach($answers as $vals2){
                            if($vals->q_id == $vals2->owner ){
                                echo "<li>".$vals2->ans_content."</li>";
                            }
                        } if( $com_counter == 0 )
                            echo "<li>"."There is no comment to display"."</li>";
                        ?>
                    </div>
                    <div id="<?php echo $vals->q_id."0";?>" class="droplists" style="display: none;">
                        <div class="contact_right" style="padding: 5px 5px 5px 5px;width: 100%;">
                            <?php echo form_open('Welcome/takeCommentIn'); ?>
                            <div class="contact-form" >
                                <input name="owner" value="<?php echo 'q'.$vals->q_id;?>" style="visibility: hidden;"/>
                                <input name="blog" value="blog" style="visibility: hidden;"/>
                        ...
                        foreach($comments as $vals3){
                            if('q'.$vals->q_id == $vals3->com_owner){
    ...
    <div class="blog_main" style="margin: 10px 0px;">
        <!-- start slider-text -->
...
<div style="min-height: 330px; margin: 20px 0px;background: #cccccc;">
    <div class="contact" style="margin: 10px;">
        <div class="contact_right" style="width: 95%;margin: 0% 2%;">
            <div class="contact-form">
                <h3>New Question</h3>
                <?php echo form_open('Welcome/doQuestion'); ?>
                <div>
                    <span><label>Title</label></span>
                    <span><input name="title" type="text" class="textbox" required="required" placeholder="Title of a questoin..."></span>
                </div>
                <div class="clear"></div>
